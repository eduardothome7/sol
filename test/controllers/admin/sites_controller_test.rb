...
class Admin::SitesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_site" do
    assert_difference("Admin::Site.count") do
      post admin_sites_url, params: { admin_site: { cnpj: @admin_site.cnpj, logo: @admin_site.logo, title: @admin_site.title } }
    end
  ...
  test "should update admin_site" do
    patch admin_site_url(@admin_site), params: { admin_site: { cnpj: @admin_site.cnpj, logo: @admin_site.logo, title: @admin_site.title } }
